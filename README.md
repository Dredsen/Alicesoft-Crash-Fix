...
A longer write-up of why this happens and how the patch works is at [Alicesoft JST Timezone Fix Blog Post](https://dredsen.github.io/post.html?p=alicesoft-jst-timezone-fix).
## Requirements
